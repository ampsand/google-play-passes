...
class Services
{
     ...
     *
     *******************************/
    public function makeFatJwt($data, $verticalType, $classId, $objectId)
    {
     ...
     *
     *******************************/
    public function makeObjectJwt($data, $verticalType, $classId, $objectId)
    {
        $signedJwt = NULL;
        $classResourcePayload = NULL;
        $objectResourcePayload = NULL;
    ...
    public function makeSkinnyJwt($data, $verticalType, $classId, $objectId)
    {
        ...
        try {
            ...
            // https://pay.google.com/gp/m/issuer/list
            if ($verticalType == VerticalType::OFFER) {
                $classResourcePayload = ResourceDefinitions::makeOfferClassResource($data, $classId);
                $objectResourcePayload = ResourceDefinitions::makeOfferObjectResource($data, $classId, $objectId);
                $classResponse = $restMethods->insertOfferClass($classResourcePayload);
