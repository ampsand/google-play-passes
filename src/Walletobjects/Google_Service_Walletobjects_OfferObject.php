...
class Google_Service_Walletobjects_OfferObject extends Google_Collection
{
    ...
    public $classId;
    protected $classReferenceType = 'Walletobjects\Google_Service_Walletobjects_OfferClass';
    ...
    public function setClassReference(Walletobjects\Google_Service_Walletobjects_OfferClass $classReference)
    {
