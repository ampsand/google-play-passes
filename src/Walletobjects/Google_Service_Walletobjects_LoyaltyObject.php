...
class Google_Service_Walletobjects_LoyaltyObject extends \Google_Collection
{
    ...
    public $classId;
    protected $classReferenceType = 'Ampsand\GooglePlayPasses\Walletobjects\GoogleService_Walletobjects_LoyaltyClass';
    ...
    protected $loyaltyPointsType = 'Ampsand\GooglePlayPasses\Walletobjects\GoogleService_Walletobjects_LoyaltyPoints';
    protected $loyaltyPointsDataType = '';
    protected $messagesType = 'Ampsand\GooglePlayPasses\Walletobjects\GoogleService_Walletobjects_Message';
    protected $messagesDataType = 'array';
    protected $secondaryLoyaltyPointsType = 'Ampsand\GooglePlayPasses\Walletobjects\GoogleService_Walletobjects_LoyaltyPoints';
