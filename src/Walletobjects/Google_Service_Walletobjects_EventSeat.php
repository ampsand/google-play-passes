...
class Google_Service_Walletobjects_EventSeat extends Google_Model
{
    ...
    protected $gateType = 'Walletobjects\Google_Service_Walletobjects_LocalizedString';
    protected $gateDataType = '';
    public $kind;
    protected $rowType = 'Walletobjects\Google_Service_Walletobjects_LocalizedString';
    protected $rowDataType = '';
    protected $seatType = 'Walletobjects\Google_Service_Walletobjects_LocalizedString';
    protected $seatDataType = '';
    protected $sectionType = 'Walletobjects\Google_Service_Walletobjects_LocalizedString';
