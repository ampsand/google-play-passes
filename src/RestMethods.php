...
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects;
use Google_Client;
...
class RestMethods {
    ...
    public function insertOfferClass($offerClass){
        ...
        //// The methods to call these from client library are in Google_Service_Walletobjects_Uri.php
