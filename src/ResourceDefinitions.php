...
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_AirportInfo;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_Barcode;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_BoardingAndSeatingInfo;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_DateTime;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_EventDateTime;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_EventSeat;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_EventTicketClass;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_EventTicketObject;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_EventVenue;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_FlightCarrier;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_FlightClass;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_FlightHeader;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_FlightObject;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_GiftCardClass;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_GiftCardObject;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_Image;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_ImageModuleData;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_ImageUri;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_InfoModuleData;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LabelValue;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LabelValueRow;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LatLongPoint;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LinksModuleData;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LocalizedString;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LoyaltyClass;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LoyaltyObject;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LoyaltyPoints;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_LoyaltyPointsBalance;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_Message;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_Money;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_OfferClass;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_OfferObject;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_ReservationInfo;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_TextModuleData;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_TicketLeg;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_TimeInterval;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_TransitClass;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_TransitObject;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_TranslatedString;
use Ampsand\GooglePlayPasses\Walletobjects\Google_Service_Walletobjects_Uri;
...
class ResourceDefinitions
{
     ...
     *
     *******************************/
    public static function makeOfferClassResource($data, $classId)
    {
        ...
        $titleImageUri->setUri($data['logo']);
        $titleImage = new Google_Service_Walletobjects_Image();
        $titleImage->setSourceUri($titleImageUri);

        $heroImageUri = new Google_Service_Walletobjects_ImageUri();
        $heroImageUri->setUri($data['hero']);
        $heroImage = new Google_Service_Walletobjects_Image();
        $heroImage->setSourceUri($heroImageUri);
        ...
        $payload->setTitle($data['coupon_amount']);

        $payload->setTitleImage($titleImage);
        $payload->setHeroImage($heroImage);
     ...
     *
     *******************************/
    public static function makeOfferObjectResource($data, $classId, $objectId)
    {
        ...
        $barcode->setType("TEXT_ONLY");
        $barcode->setValue($data['coupon_code']);
